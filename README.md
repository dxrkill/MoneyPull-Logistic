...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <!-- 2. Блок "Главный экран" (Hero Section) -->
  ...
  <!-- 3. Калькулятор расчета стоимости -->
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <form id="calc-form" class="space-y-6">
          ...
          <!-- Дистанция перевозки -->
          <div>
            <label for="distance" class="block text-sm font-semibold mb-2">Расстояние перевозки (км)</label>
            <input type="number" id="distance" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary" placeholder="Например: 50" min="0">
          </div>
          
          <!-- Тип разгрузки -->
          <div>
            <label for="unloading" class="block text-sm font-semibold mb-2">Тип разгрузки</label>
            <select id="unloading" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary">
              <option value="manual">Ручная</option>
              <option value="crane">Манипулятор</option>
            </select>
          </div>
          
          <!-- Кнопка расчета -->
          <div>
            <button type="button" id="calculate-btn" class="w-full px-4 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-blue-700 transition">Рассчитать</button>
          </div>
        </form>
        
        <!-- Результат -->
        <div id="result" class="mt-6 text-center text-lg font-bold text-primary hidden">
          Примерная стоимость: <span id="price">0</span> руб.
          <div class="mt-4">
            <a href="#contact" class="px-4 py-2 bg-accent text-white rounded-lg font-semibold hover:bg-orange-600 transition">Заказать с точным расчетом</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="about" class="py-16">
    <div class="container mx-auto px-6">
      <h2 class="text-3xl font-bold mb-8 text-center">О компании</h2>
      <div class="flex flex-col md:flex-row md:space-x-6">
        <!-- Описание -->
        <div class="md:w-1/2 space-y-4">
          <p>Компания <strong>MoneyPull Logistic</strong> имеет более 10 лет опыта в сфере грузоперевозок. Мы специализируемся на транспортировке строительных материалов и оборудования, обеспечивая быстрые и надежные услуги для строительных фирм.</p>
          <p>Наш автопарк состоит из современных шаланд с манипуляторами, позволяющих перевозить различные виды грузов, включая бытовки, опоры, арматуру и многое другое.</p>
          <p>На сегодняшний день мы успешно выполнили более 5000 заказов, что подтверждает нашу надежность и профессионализм.</p>
        </div>
        <!-- Преимущества -->
        <div class="md:w-1/2 space-y-4">
          <h3 class="text-2xl font-semibold mb-4">Наши преимущества</h3>
          <ul class="space-y-2">
  ...
  <!-- 6. Блок "Преимущества работы с нами" -->
  <section id="advantages" class="py-16">
    <div class="container mx-auto px-6">
      <h2 class="text-3xl font-bold mb-8 text-center">Преимущества работы с нами</h2>
      <div class="flex flex-col md:flex-row md:justify-around space-y-6 md:space-y-0">
        ...
        <div class="flex items-center space-x-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422a12.083 12.083 0 01.84 6.566A12.095 12.095 0 0112 21a12.095 12.095 0 01-6.999-1.856 12.083 12.083 0 01.84-6.566L12 14z" />
          </svg>
          <span>Полная страховка груза</span>
        </div>
        <!-- Преимущество 4 -->
        <div class="flex items-center space-x-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <span>Срочная доставка — от 1 часа</span>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="space-y-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          <div class="flex items-center mb-4">
            <img src="https://example.com/client1.jpg" alt="Клиент 1" class="h-12 w-12 rounded-full mr-4">
            <div>
              <h4 class="text-xl font-semibold">ООО СтройИнвест</h4>
            ...
            <p class="text-gray-700">"Отличный сервис! Быстрая доставка и профессиональные водители. Рекомендуем MoneyPull Logistic для всех строительных нужд."</p>
          </div>
        </div>
        <!-- Отзыв 2 -->
        <div class="bg-white p-6 rounded-lg shadow-md">
          <div class="flex items-center mb-4">
            <img src="https://example.com/client2.jpg" alt="Клиент 2" class="h-12 w-12 rounded-full mr-4">
            <div>
              <h4 class="text-xl font-semibold">АО СтройТех</h4>
              <div class="flex items-center">
                <!-- Звезды -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.97a1 1 0 00.95.69h4.176c.969 0 1.371 1.24.588 1.81l-3.38 2.457a1 1 0 00-.364 1.118l1.287 3.97c.3.921-.755 1.688-1.54 1.118L10 13.347l-3.38 2.457c-.784.57-1.838-.197-1.539-1.118l1.286-3.97a1 1 0 00-.364-1.118L2.93 9.397c-.783-.57-.38-1.81.588-1.81h4.176a1 1 0 00.95-.69l1.286-3.97z" />
  ...
  <!-- 8. Блок "Часто задаваемые вопросы" -->
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <form id="request-form" class="space-y-6">
          ...
          <!-- Тип груза -->
          <div>
            <label for="request-cargo-type" class="block text-sm font-semibold mb-2">Тип груза</label>
            <select id="request-cargo-type" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary">
              <option value="b">Бытовка</option>
              <option value="o">Опоры</option>
              <option value="s">Стройматериалы</option>
              <option value="a">Арматура</option>
          ...
          <div>
            <label for="date-time" class="block text-sm font-semibold mb-2">Дата и время перевозки</label>
            <input type="datetime-local" id="date-time" class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary" required>
          </div>
          
          <!-- Кнопка отправки -->
          <div>
            <button type="submit" class="w-full px-4 py-2 bg-accent text-white rounded-lg font-semibold hover:bg-orange-600 transition">Оставить заявку</button>
          </div>
        </form>
        <!-- Сообщение об успешной отправке -->
        <div id="request-success" class="mt-4 text-center text-green-500 font-semibold hidden">
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="flex flex-col md:flex-row md:space-x-6">
        ...
        <div class="md:w-1/2 mb-6 md:mb-0">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!..." width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" class="rounded-lg"></iframe>
        </div>
        <!-- Контактные данные -->
        <div class="md:w-1/2 space-y-4">
          <div>
            <h3 class="text-xl font-semibold">Наш офис</h3>
            <p>ул. Строителей, д. 10, офис 5</p>
          </div>
          <div>
            <h3 class="text-xl font-semibold">Телефон</h3>
            <p><a href="tel:+1234567890" class="text-primary underline">+1 (234) 567-890</a></p>
          </div>
          <div>
            <h3 class="text-xl font-semibold">Email</h3>
            <p><a href="mailto:info@moneypull.com" class="text-primary underline">info@moneypull.com</a></p>
          </div>
          <div>
            <h3 class="text-xl font-semibold">Социальные сети</h3>
  ...
  <script>
    ...
    document.getElementById('calculate-btn').addEventListener('click', function () {
      ...
      let basePrice = 1000; // Базовая стоимость
      let cargoPrice = 0;
      let dimensionPrice = 0;

      // Определение цены за тип груза
      switch(cargoType) {
        case 'b': // Бытовка
          cargoPrice = 500;
          break;
      ...
      // Дополнительная плата за габариты (пример)
      const dimensionParts = dimensions.split('x').map(part => parseFloat(part));
      if (dimensionParts.length === 3) {
        const [length, width, height] = dimensionParts;
        dimensionPrice = (length + width + height) * 50; // Пример расчета
      }

      // Расчет стоимости
      let price = basePrice + cargoPrice + (weight * 100) + (distance * 5) + dimensionPrice;

      // Доплата за тип разгрузки
      if (unloading === 'crane') {
        price += 500; // Доплата за манипулятор
      }
